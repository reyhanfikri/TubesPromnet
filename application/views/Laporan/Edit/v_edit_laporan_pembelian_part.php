      ...
      <tbody>
        <?php $no = 1; $total_item = 0; $total_qty_tambah = 0; $total = 0; foreach ($data_detail as $val) { ?>
          <tr>
            ...
            <td align="right" width="150" style="padding-top: 4px; padding-bottom: 4px;"><input style="padding-left: 5px; width: 50px; border-radius: 5px;" type="hidden" name="qty_tambah_before_<?php echo $no; ?>" value="<?php echo $val->qty_tambah; $total_qty_tambah += $val->qty_tambah; ?>"><input style="padding-left: 5px; width: 50px; border-radius: 5px;" type="number" min="1" name="qty_tambah_after_<?php echo $no; ?>" value="<?php echo $val->qty_tambah; $total_qty_tambah += $val->qty_tambah; ?>"> Pcs</td>
          ...
          <input type="hidden" name="stok_part_<?php echo $no; ?>" value="<?php echo $val->stok_part; ?>">
        <?php } ?>
          <tr>
