    ...
    <table class="table table-hover">
      <thead>
        <tr class="table-info">
          ...
          <th scope="col" style="padding-top: 4px; padding-bottom: 4px;">Jumlah Part</th>
      ...
      <tbody>
        ...
        ?>
          <tr>
            ...
            <td style="padding-top: 4px; padding-bottom: 4px;"><?php echo $val->jumlah_part; $graph_jumlah_part[] = $val->jumlah_part; ?></td>
        ...
        ?>
          <tr>
            ...
            <td style="padding-top: 4px; padding-bottom: 4px;"><?php echo 0; $graph_jumlah_part[] = 0; ?></td>
