  ...
  <table class="table table-hover">
    <thead>
      <tr class="table-info">
        ...
        <th scope="col" style="padding-top: 4px; padding-bottom: 4px;">Jumlah</th>
    ...
    <?php $i = 1; $totalHarga = 0; $totalJumlah = 0; foreach ($transPart as $val) { ?>
      <tr>
        ...
        <td style="padding-top: 4px; padding-bottom: 4px;"><?php echo $val->harga_part; ?></td>
        <td style="padding-top: 4px; padding-bottom: 4px;"><?php echo $val->jumlah; $totalJumlah = $totalJumlah + $val->jumlah; ?></td>
        <td style="padding-top: 4px; padding-bottom: 4px;"><?php echo $val->harga_part*$val->jumlah; $totalHarga = $totalHarga + ($val->harga_part*$val->jumlah); ?></td>
